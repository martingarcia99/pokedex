...
export const PokemonCard: React.FC<PokemonCardProps> = ({ pokemon, pokemonId }) => {
    ...
    return (
        <div className={`${mainType}-background relative h-56 rounded-lg shadow-lg p-4 cursor-pointer hover:scale-105 hover:shadow-md transition-all border-black border`} data-testid='pokemon-card'>
